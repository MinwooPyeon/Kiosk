...
class TestResultRemoteDataSource(
    ...
    suspend fun sendPresbyopiaTestResult(
        ...
        return try {
            if (token != null) {
                val testData = PresbyopiaTestData(
    ...
    suspend fun sendGripStrengthTestResult(
        ...
        return try {
            if (token != null) {
                val testData = GripStrengthTestData(
    ...
    suspend fun sendBloodPressureTestResult(
        ...
        return try {
            if (token != null) {
                val testData = BloodPressureTestData(
    ...
    suspend fun sendPulmonaryFunctionTestResult(
        ...
        return try {
            if (token != null) {
                val testData = PulmonaryTestData(
