...
fun UserSignUpScreen(
    ...
    Column(
        ...
        if (!signupSuccess) {
            ...
            StyledText(StringProvider.getString(R.string.user_signup_title), com.pixelro.nenoonkiosk.ui.components.TextStyle.Title)
            ...
            if (errorMessage != null) {
                StyledText(errorMessage!!, com.pixelro.nenoonkiosk.ui.components.TextStyle.Error)
                Spacer(modifier = Modifier.height(20.dp))
            }
