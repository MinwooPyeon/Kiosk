...
class TestResultViewModel @Inject constructor(
    ...
    fun sendResultToServer(surveyId: Long, testType: TestType, testResult: Any?, token: String?) {
        viewModelScope.launch {
            when (testType) {
                ...
                TestType.Dementia -> {
                    ...
                    // Send to Server
                    val request = SendDementiaTestResultRequest(
                        surveyId = surveyId,
                ...
                TestType.GripStrength -> {
                    ...
                    // Send to Server
                    val request = SendGripStrengthTestResultRequest(
                        surveyId = surveyId,
                ...
                TestType.BloodPressure -> {
                    ...
                    val request = SendBloodPressureTestResultRequest(
                        surveyId = surveyId,
                ...
                TestType.PulmonaryFunction -> {
                    ...
                    val request = SendPulmonaryFunctionTestResultRequest(
                        surveyId = surveyId,
                        pulmonaryPower = testResult.pulmonaryPower,
                        pulmonaryCapacity = testResult.pulmonaryCapacity,
                        pulmonaryAge = testResult.pulmonaryAge,
