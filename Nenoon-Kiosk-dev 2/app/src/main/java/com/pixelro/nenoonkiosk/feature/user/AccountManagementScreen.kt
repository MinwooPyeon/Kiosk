...
fun AccountManagementScreen(
    ...
    fun generateQrCodeBitmapInternal(userId: String, password: String) {
        ...
        Column(
            ...
            Column(
                ...
                if (showProgressIndicator) {
                    ...
                    StyledText(text = StringProvider.getString(R.string.qr_code_user_name, userData?.name ?: StringProvider.getString(R.string.default_user_name)))
                ...
                PrimaryButton(
                    ...
                    text = if (!viewModel.isUserSignInSkipped()) StringProvider.getString(
                        R.string.settings_signout)
                    else StringProvider.getString(R.string.signin, )
                )
            }
        }
    }
