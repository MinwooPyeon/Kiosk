package com.pixelro.nenoonkiosk.feature.screen.iotdevice.BP170B
...
@HiltViewModel
class BP170BViewModel @Inject constructor(application: Application) : AndroidViewModel(application) {
