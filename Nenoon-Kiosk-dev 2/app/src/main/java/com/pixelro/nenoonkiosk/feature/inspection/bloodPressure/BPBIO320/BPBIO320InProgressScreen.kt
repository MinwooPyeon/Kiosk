...
fun BPBIO320InProgressScreen(
    ...
    LaunchedEffect(connectionState) {
        if (connectionState == IB_SDKConst.CONNECTED && !testInProgress) {
            ...
            TTS.speechTTS(StringProvider.getString(R.string.bpbio320_measurement_in_progress), TextToSpeech.QUEUE_ADD)
        ...
        if (testInProgress) {
            ...
            if (isLastResultComplete) {
                ...
                if (result != null && isResultValid(result) && errorMessage.isNullOrBlank()) {
                    ...
                    TTS.speechTTS(StringProvider.getString(R.string.bpbio320_measurement_completed), TextToSpeech.QUEUE_ADD)
                } else {
