...
object SttConfig {
    object Recognition {
        const val SHORT_COMPLETE_SILENCE_MS = 800L
        const val SHORT_POSSIBLY_COMPLETE_SILENCE_MS = 600L
        const val SHORT_MINIMUM_LENGTH_MS = 400L

        const val SHORT_WITH_HINTS_COMPLETE_SILENCE_MS = 700L
        const val SHORT_WITH_HINTS_POSSIBLY_COMPLETE_SILENCE_MS = 500L
