...
fun GripStrengthInProgressScreen(
    ...
    Column(
        ...
        when (state.testState) {
            GripStrengthInspectionState.RightHandReady, GripStrengthInspectionState.LeftHandReady -> {
...
@Preview(showBackground = true, widthDp = 888, heightDp = 1422, name = "Right – Measuring")
@Composable
...
@Preview(showBackground = true, widthDp = 888, heightDp = 1422, name = "Right – Done")
@Composable
...
@Preview(showBackground = true, widthDp = 888, heightDp = 1422, name = "Left – Ready")
@Composable
private fun Preview_LeftReady() {
    GripStrengthInProgressScreen(
        state = GripInProgressUiState(testState = GripStrengthInspectionState.LeftHandReady),
        onEvent = {},
    )
}


@Preview(showBackground = true, widthDp = 888, heightDp = 1422, name = "Left – Measuring")
@Composable
...
@Preview(showBackground = true, widthDp = 888, heightDp = 1422, name = "Left – Done")
@Composable
