...
//                canvas.drawBitmap(qrImg, 0f, 0f, null)
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.amsler_grid_name,
                    ),
                    300f,
                    baseline,
                    paint,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.printer_left_eye,
                    ),
                    150f,
                    baseline + 60f,
                    paint,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.printer_right_eye,
                    ),
                    450f,
                    baseline + 60f,
                    paint,
                ...
                if (testResult.leftEyeDisorderType[0] != MacularDisorderType.Normal) {
                    canvas.drawText(
                        StringProvider.getString(
                            com.pixelro.nenoonkiosk.R.string.printer_problem,
                        ),
                        70f,
                        baseline + 160f,
                        paint,
...
//                canvas.drawBitmap(qrImg, 0f, 0f, null)
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.mchart_name,
                    ),
                    300f,
                    baseline,
                    paint,
...
//                canvas.drawText("+82-31-8182-9290", 0f, baseline + 360f, paint)
            ...
            InspectionType.GripStrength -> {
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.test_predescription_grip_strength_title1,
                    ),
                    300f,
                    baseline,
                    paint,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.test_result_left,
                    ),
                    150f,
                    baseline + 60f,
                    paint,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.test_result_right,
                    ),
                    450f,
                    baseline + 60f,
                    paint,
            ...
            InspectionType.BloodPressure -> {
                ...
                canvas.drawText(
                    StringProvider.getString(
                        (com.pixelro.nenoonkiosk.R.string.test_predescription_blood_pressure_title1),
                    ),
                    300f,
                    baseline,
                    paint,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.blood_pressure_monitor_systolic,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.blood_pressure_monitor_diastolic,
                ...
                canvas.drawText(
                    StringProvider.getString(
                        com.pixelro.nenoonkiosk.R.string.blood_pressure_monitor_heart_rate,
            ...
            InspectionType.Dementia -> {
                ...
                canvas.drawText(
                    StringProvider.getString(
                        (com.pixelro.nenoonkiosk.R.string.dementia_test),
                    ),
                    300f,
                    baseline,
                    paint,
